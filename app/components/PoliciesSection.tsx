    ...
    >
      <div className="mx-auto max-w-6xl space-y-10 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <ul className="mt-3 space-y-2 text-sm text-slate-700">
            <li>
              ...
              may collect your name, contact details, delivery addresses,
              order history and limited device information to provide our
              services.
            </li>
            <li>
        ...
        >
          ...
          <p className="mt-3 text-sm text-slate-700">
            This policy describes how cancellations, refunds and returns are
            handled for orders placed through FreshMart.
          </p>
          <ul className="mt-3 space-y-2 text-sm text-slate-700">
            <li>
              <span className="font-semibold">Order cancellation:</span> orders
              can usually be cancelled before they are packed or dispatched.
              Cancellation options may vary by store and time. Please contact
              us quickly if you wish to cancel.
            </li>
            <li>
              <span className="font-semibold">Refunds:</span> if an order is
              cancelled, not delivered, or delivered with missing/incorrect
              items, we will review the issue and process a refund or
              adjustment as appropriate. Eligible refunds are processed to the
              original payment method via Razorpay within a reasonable
              timeframe.
            </li>
            <li>
              <span className="font-semibold">Quality issues:</span> if you
              receive damaged or poor-quality products, please share clear
              photos and details within a short time after delivery so that we
              can investigate and support you.
            </li>
            <li>
              <span className="font-semibold">Contact for refunds:</span> for
              any refund or cancellation request, email us at
              {" "}
              <a
                href="mailto:support@freshmart.in"
                className="text-emerald-700 hover:underline"
        ...
        >
          ...
          <ul className="mt-3 space-y-2 text-sm text-slate-700">
            <li>
              ...
              provides a platform for customers in India to order groceries
              from partner stores and have them delivered.
            </li>
            <li>
            ...
            <li>
              <span className="font-semibold">Payments:</span> online payments
              are processed via Razorpay. By completing a transaction, you
              agree to Razorpay&apos;s terms in addition to these terms.
            </li>
            <li>
              <span className="font-semibold">Liability:</span> while we aim to
              provide a reliable service, there may be delays or
              cancellations due to factors beyond our control. Our liability is
              limited to the value of the order in such cases.
            </li>
            <li>
              ...
              versions will be made available within the app or on the
              website.
            </li>
          </ul>
        </div>
